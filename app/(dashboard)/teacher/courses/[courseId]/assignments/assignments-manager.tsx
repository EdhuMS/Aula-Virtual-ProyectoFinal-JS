            ...
            {error ? (
                ...
                <div className="grid gap-4">
                    {assignments?.map((assignment: any) => (
                        <div key={assignment.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
